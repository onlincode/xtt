...
`;var{dgnl:t,thitn:e,hocba:o,diemRaw:h,diemCong:c,diemUuTien:l,diemFull2022:a,diem2023:u,diemUuTien2023:p,diemFull2023:d}=n;let s=["Cột điểm thi ĐGNL: "+t,"Cột điểm thi Tốt nghiệp THPT: "+e,"Cột điểm học tập THPT: "+o,"Cột điểm cộng th\xe0nh t\xedch: "+c,"Cột điểm Ưu ti\xean: "+l,"Điểm x\xe9t tuyển 2022: "+a+" l\xe0m tr\xf2n: "+a.toFixed(3)],m=document.getElementById("ajaxDiv3");m.innerHTML+=s.map(n=>"<p>"+n+"</p>").join(""),alert(s.map(n=>n+"\n").join("")),document.getElementById("tinhdiem").disabled=!1}function getData(n){document.getElementById("tinhdiem").disabled=!0;let t=document.getElementById("dgnl").value,e=document.getElementById("tohop").value,o=document.getElementById("thitn").value,h=document.getElementById("thi1").value,c=document.getElementById("thi2").value,l=document.getElementById("thi3").value,a=document.getElementById("hocba").value,u=document.getElementById("hoc11").value,p=document.getElementById("hoc12").value,d=document.getElementById("hoc13").value,s=document.getElementById("hoc21").value,m=document.getElementById("hoc22").value,g=document.getElementById("hoc23").value,r=document.getElementById("hoc31").value,b=document.getElementById("hoc32").value,v=document.getElementById("hoc33").value,y=document.getElementById("ielts").value,k=document.getElementById("toefl").value,_=document.getElementById("toeic1").value,T=document.getElementById("toeic2").value,B=document.getElementById("hsgqg").value,f=document.getElementById("khkt").value,E=document.getElementById("hsgtp").value,I=document.getElementById("sat").value,x=document.getElementById("hocthuat").value,S=document.getElementById("vannghe").value,N=document.getElementById("doituong").value,L=document.getElementById("khuvuc").value;try{guiDulieu({dgnl:t,tohop:e,thitn:o,thi1:h,thi2:c,thi3:l,hocba:a,hoc11:u,hoc12:p,hoc13:d,hoc21:s,hoc22:m,hoc23:g,hoc31:r,hoc32:b,hoc33:v,ielts:y,toefl:k,toeic1:_,toeic2:T,hsgqg:B,khkt:f,hsgtp:E,sat:I,hocthuat:x,vannghe:S,doituong:N,khuvuc:L},displayKetQua)}catch(w){alert(w)}}function renderToHop(n){return`<select id="tohop" onchange="handleToHop()">
    ...
    </select>`}function guiDulieu(n,t){return fetch("https://faas-sgp1-18bc02ac.doserverless.co/api/v1/web/fn-04566e3b-5665-42cf-b9d4-b8baba8366aa/default/qsb",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}).then(n=>n.json()).then(t).catch(alert)}function renderXetThu(n){return` 
  <div class="form-group form-check"></div>
