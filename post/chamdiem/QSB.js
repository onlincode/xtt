...
<input  type="number" class="form-control"  inputmode="decimal" step="any" oninput="handleThi()" onchange = "handleThi()" id="thi1"><br>
</div>
<div class="form-group  col-md-4"> 
<label for="thi2" class="mon2">Điểm thi m\xf4n 2:</label>
<input  type="number" class="form-control"  inputmode="decimal" step="any" oninput="handleThi()" onchange = "handleThi()" id="thi2"><br>
</div>
<div class="form-group  col-md-4"> 
<label for="thi3" class="mon3">Điểm thi m\xf4n 3:</label>
<input  type="number" class="form-control"  inputmode="decimal" step="any" oninput="handleThi()" onchange = "handleThi()" id="thi3">
</div>
</div>
